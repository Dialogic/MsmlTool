...
//                MsmlApp.optionsRequest(request, this);
//                break;
//            case Request.INFO:
//                MsmlApp.infoRequest(request);
//                break;
//            case Request.ACK:
//                MsmlApp.recievedRequest(request, this);
//                break;
//            case Request.CANCEL:
//                MsmlApp.cancelRequest(request, this);
//                break;
//            case Request.BYE:
//                MsmlApp.recievedRequest(request, this);
//                break;
...
//                    case Request.INVITE:
//                        MsmlApp.sipCallResponse(response, cSeq, inboundCall);
//                        break;
//                    case Request.INFO:
//                        break;
//                    case Request.BYE:
...
//                MsmlApp.requestTerminated(response, inboundCall);
//                break;
//        }
//    }
//
...
//        MsmlApp.updateCallTextBridgeRequestToXMS(request);
//        isInvite = true;
...
//            MsmlApp.updateCallTextBridgeRequestToXMS(ackRequest);
...
//            MsmlApp.updateCallTextBridgeSentResponse(optionsResponse);
...
//            toHeader.setTag(Integer.toHexString(new Random().nextInt(0xffffff) + 0xffffff));
//            MsmlApp.updateCallTextBridgeSentResponse(tryingResponse);
...
//            toHeader.setTag(Integer.toHexString(new Random().nextInt(0xffffff) + 0xffffff));
//            MsmlApp.updateCallTextBridgeSentResponse(ringingResponse);
...
//            MsmlApp.updateCallTextBridgeSentResponse(okResponse);
...
//        MsmlApp.diaplayInfoResponse(response);
//    }
//
//    /**
